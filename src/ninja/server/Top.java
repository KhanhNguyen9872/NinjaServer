...
public class Top
{
    ...
    protected static String getStringBXH(final Char _Char, final int type) {
        ...
        switch (type) {
            ...
            case 4: {
                ...
                for (final Entry top : Top.tops[type]) {
                    str = str + String.format(Text.get(0, 186), top.index, top.name, Util.getFormatNumber(top.nTop)) + "\n";
                }
                break;
            }
            case 5: {
    ...
    static {
        tops = new ArrayList[6];
        arrSizeTop = new int[] { 10, 10, 10, 10, 10, 10 };
        isRefresh = new boolean[] { true, true, true, true, true, true };
    }
