                ...
                try {
                    for (int i = tileMap.aCharInMap.size() - 1; i >= 0; --i) {
                        ...
                        if (_char != null) {
                            ...
                            if (this.isMapLangCo() && (_char.cHP <= 0 || _char.cPk > 0) && _char.isHuman && _char.tileMap.map.isMapLangCo()) {
                    ...
                    for (short i2 = 0; i2 < tileMap.aItemMap.size(); ++i2) {
                        ...
                        if (itemMap != null) {
                            if (itemMap.timeRemove <= System.currentTimeMillis()) {
                            ...
                            synchronized (mob2.LOCK) {
                                ...
                                if (!isXoa) {
                                    if (mob2.timeStartDie + mob2.RefreshTimeDie < System.currentTimeMillis() && !mob2.removeWhenDie && mob2.injureThenDie) {
                                        ...
                                        if (mob2.levelBoss != 3 && !mob2.isBoss && mob2.level > 9 && !this.isBackCaveMap() && mob2.templateId != 98 && mob2.templateId != 99) {
                                            levelBoss = 0;
