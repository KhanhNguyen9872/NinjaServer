...
{
    protected static final byte CAVE_35 = 0;
    protected static final byte CAVE_45 = 1;
    protected static final byte CAVE_55 = 2;
    protected static final byte CAVE_65 = 3;
    protected static final byte CAVE_75 = 4;
    protected static final byte CAVE_95 = 5;
    protected static final short PRE_INDEX = 0;
    protected static final byte POINT_BT = 1;
    ...
    protected static final int setTimeLength = 3600;
    ...
    public BackCave() {
        this.ACharInCave = new ArrayList<Char>();
    ...
    protected static void ItemUse(final Char _char, final Item item) {
        ...
        else if (item.template.id == 647 && Util.nextInt(1000) < 2) {
    ...
    static {
        ...
        BackCave.baseId = 0;
        LOCK = new Object();
        arrCave = new ArrayList<BackCave>();
    }
}
