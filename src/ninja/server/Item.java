...
public class Item
{
    ...
    protected Item clone() {
        ...
        if (this.options != null) {
            item.options = new ArrayList<ItemOption>();
    ...
    protected boolean isItemChangeMap() {
        return this.itemId == 35 || this.itemId == 37;
    }
    ...
    protected boolean isItemAnimals1() {
        return (this.itemId >= 439 && this.itemId <= 444) || this.itemId == 523 || this.itemId == 524 || this.itemId == 798 || (this.itemId >= 801 && this.itemId <= 803) || this.itemId == 827 || this.itemId == 831;
    }
    ...
    protected boolean isItemMoto1() {
        return (this.itemId >= 485 && this.itemId <= 489) || this.itemId == 523 || this.itemId == 524 || this.itemId == 831;
    }
    ...
    protected boolean isEquip2() {
        return (this.itemId >= 795 && this.itemId <= 805 && this.itemId != 797) || (this.itemId >= 813 && this.itemId <= 817) || (this.itemId >= 825 && this.itemId <= 826) || this.itemId == 830;
    }
