...
public class Mob
{
    ...
    protected static void MobMeAtk(final Char _char, final Mob mob, final Char player) {
        ...
        SkillUse.AttackMob(_char.tileMap, _char, _char, mob, _char.cDame(mob.sys, 0, 0, 0, 0, 0, 0, 0, 0, false, 0, 0) * 20 / 100, false, (byte)1);
    }
    ...
    protected boolean isMobBossServer() {
        return this.isBoss && (this.level == 45 || this.level == 55 || this.level == 65 || this.level == 75);
    }
