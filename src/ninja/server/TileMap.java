...
public class TileMap
{
    ...
    protected TileMap(final Map map, final byte zoneID) {
        this.map = null;
        this.aVgo = new ArrayList<Waypoint>();
        this.aItemTreeFront = new ArrayList<ItemTree>();
        this.aItemTreeBehind = new ArrayList<ItemTree>();
        this.aItemTreeBetwen = new ArrayList<ItemTree>();
        this.aCharInMap = new ArrayList<Char>();
        this.aMob = new ArrayList<Mob>();
        this.aBuNhin = new ArrayList<BuNhin>();
        this.aNpc = new ArrayList<Npc>();
        this.aItemMap = new ArrayList<ItemMap>();
        this.aParty = new ArrayList<Party>();
        this.numPlayer = 0;
        this.numParty = 0;
        this.maxMobId = 0;
        this.lock = new Lock();
                        ...
                        if (iMap.playerId != 0 && iMap.playerId != _char.user.player.playerId) {
                            ...
                            if (item != null) {
                                ...
                                if (item.template.type == 19) {
                                    _char.user.player.upCoinLock(item.quantity, (byte)0);
                                }
    ...
    protected int tileAt(final int x, final int y) {
        int result;
        try {
    ...
    protected int tileTypeAt(final int x, final int y) {
        int result;
        try {
    ...
    protected int tileTypeAtPixel(final int px, final int py) {
        int result;
        try {
    ...
    protected int tileXofPixel(final int px) {
        return px / 24 * 24;
    }
    
    protected int tileYofPixel(final int py) {
        return py / 24 * 24;
    }
    
    public boolean isStand(final int index) {
        return this.locationStand != null && this.locationStand.get(index + "") != null;
    }
