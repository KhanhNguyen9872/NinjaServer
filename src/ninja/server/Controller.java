            ...
            try {
                ...
                switch (msg.getCommand()) {
                    ...
                    case -23: {
                        if (user != null && _char != null && tileMap != null) {
                            try {
                                ...
                                if (text.equals("BTH") || text.equals("bth")) {
                                    Admin.opMenu(_char);
                                    return;
                                }
                    ...
                    case -12: {
                        if (user != null && _char != null && tileMap != null && _char.statusMe != 14 && !_char.user.player.isTrade) {
                            ...
                            if (item != null && !item.isLock) {
                                final ItemMap itemMap = new ItemMap(item, 0, 60000, _char.cx, _char.cy);
                                try {
                    ...
                    case -9: {
                        if (user != null && _char != null && tileMap != null && _char.statusMe == 14 && !_char.user.player.isTrade) {
                            Map map;
                            if (tileMap.map.isManorMap()) {
                                map = ClanManor.getMap(tileMap.map.clanManor, (short)80);
                            }
                            else if (tileMap.map.isBackCaveMap()) {
                    ...
                    case 13: {
                        ...
                        if (MapServer.notTrade(_char.tileMap.mapID)) {
                            ...
                            else if (item2.isItemEgg()) {
                                GameCanvas.startOKDlg(session, Text.get(0, 231));
                            }
        ...
        try {
            ...
            switch (b) {
                        ...
                        if (player != null && player.ItemBagIndexNull() != -1 && player.clan != null && player.clan.clanId == _char.clan.clanId) {
                            ...
                            synchronized (clan.LOCK_CLAN) {
                                try {
                                    ...
                                    if (item6 != null && item6.template.id != 604) {
                ...
                case 122: {
                    ...
                    final byte b2 = msg.reader().readByte();
                    if (b2 == 0) {}
                    final short id = (short)msg.reader().readUnsignedByte();
                    if (b2 == 2) {
                        GameCanvas.getImgEffectAuto(_char, id);
                        break;
                    }
                    if (b2 == 3) {
                        GameCanvas.getDataEffectAuto(_char, id);
                        break;
                    }
                    break;
                }
