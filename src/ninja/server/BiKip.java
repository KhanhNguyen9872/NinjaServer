...
public class BiKip
{
        ...
        if (it == null) {
            ...
            if (success) {
                ...
                for (int m = 0; m < it.options.size(); ++m) {
                    ...
                    if (option != null) {
                        if (option.optionTemplate.id >= 2 && option.optionTemplate.id <= 4) {
                        ...
                        if (option.optionTemplate.id >= 10 && option.optionTemplate.id <= 10) {
                            final ItemOption itemOption3 = option;
                            itemOption3.param += 20;
                        }
                        if (option.optionTemplate.id >= 47 && option.optionTemplate.id <= 47) {
                        ...
                        if (option.optionTemplate.id >= 119 && option.optionTemplate.id <= 120) {
    ...
    static {
        arr_Id_Option = new int[] { 2, 3, 4, 6, 7, 10, 73, 47, 119, 120 };
