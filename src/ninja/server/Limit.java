...
public class Limit
{
    ...
    static {
        Limit.arrItemUseLimit = new Limit[] { new Limit(252, 3, false), new Limit(253, 8, false), new Limit(280, 1, true), new Limit(298, 100, true), new Limit(299, 100, true), new Limit(300, 100, true), new Limit(301, 100, true), new Limit(308, 10, false), new Limit(309, 10, false), new Limit(705, 6, true) };
    }
}
